...
/*
The argument passed to shallowReactive is [[]], which is an array containing an empty array. This means that history is initialized as a reactive object that contains a single element, which is an empty array.
*/
